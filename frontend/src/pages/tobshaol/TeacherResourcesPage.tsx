  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div id={DASHBOARD_ID} className="mt-16 scroll-mt-20 rounded-2xl border border-white/10 bg-teen-surface p-6 sm:p-8">
          <h2 className="text-2xl font-black uppercase tracking-tight text-white sm:text-3xl">
            {t("tobshaol.teacher.dashboardHeading")}
          </h2>

          <dl className="mt-5 grid grid-cols-3 gap-4 rounded-xl bg-white/5 p-5 text-center">
            <div>
              <dd className="text-2xl font-black text-teen-pink-400 sm:text-3xl">{teacherResources.length}</dd>
              <dt className="mt-1 text-xs font-bold text-white/50 sm:text-sm">
                {t("tobshaol.teacher.statsResources")}
              </dt>
            </div>
            <div>
              <dd className="text-2xl font-black text-teen-cyan-400 sm:text-3xl">{categoryCount}</dd>
              <dt className="mt-1 text-xs font-bold text-white/50 sm:text-sm">
                {t("tobshaol.teacher.statsCategories")}
              </dt>
            </div>
            <div>
              <dd className="text-2xl font-black text-teen-yellow-400 sm:text-3xl">{newThisMonth}</dd>
              <dt className="mt-1 text-xs font-bold text-white/50 sm:text-sm">
          ...
          <div className="relative mt-6 max-w-lg">
            ...
            <input
              ...
              className="w-full rounded-full border border-white/15 bg-teen-ink py-3 pl-10 pr-4 text-sm text-white placeholder:text-white/40 focus:border-teen-pink-400"
            />
          </div>
          ...
          {isFiltering ? (
            <div className="mt-8">
              <p className="text-sm font-bold text-white/50" role="status">
            ...
            <>
              <section className="mt-10">
                <h3 className="text-lg font-black uppercase tracking-wide text-white/80">
